...
module Openapi
  module Entities
    class CoreRetentionModelDataItem < Grape::Entity
      ...
      expose :org_code_core_retention, documentation: { type: 'Float', desc: 'Org code core retention rate / 组织代码核心开发者（含管理者）留存率', nullable: true }
      expose :org_issue_core_retention, documentation: { type: 'Float', desc: 'Org issue core retention rate / 组织Issue核心开发者（含管理者）留存率', nullable: true }
      expose :individual_code_core_retention, documentation: { type: 'Float', desc: 'Individual code core retention rate / 个人代码核心开发者（含管理者）留存率', nullable: true }
      expose :individual_issue_core_retention, documentation: { type: 'Float', desc: 'Individual issue core retention rate / 个人Issue核心开发者（含管理者）留存率', nullable: true }
